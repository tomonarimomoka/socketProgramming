...
public class ItemQuote {
	...
	public ItemQuote(long itemNumber , String itemDscription, int quantity, int unitPrice, boolean discounted, boolean inStock) {
		this.itemNumber = itemNumber;
		this.itemDescription = itemDscription;
